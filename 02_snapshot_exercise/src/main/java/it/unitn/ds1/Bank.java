...
public class Bank extends AbstractActor {
    ...
    private void captureState() {
        ...
        // TODO 0: Start considering inside which function and under which condition you
        // should print the balance for it to be consistent (consistent cut)
        // NOTE: Print your state only after the end of the snapshot protocol for this
        // node
        // You have to print something in the format:
        // System.out.println("Bank " + id + " snapId: "+ snapId + " state: " +
        // balance);
        // Regarding prints pay attention as "string" + 0 + 1 is interpreted as
        // ("string" + 0) + 1
    ...
    private void onToken(Token token) {
        ...
        // TODO 3: manage the first Token reception and the snapshot termination for
        // this node
